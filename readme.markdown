...
## Licenses
* `CC0` – [CC0](4.0/zero.markdown)
* `BY` – [Attribution](4.0/by.markdown)
* `BY-NC` – [Attribution-NonCommercial](4.0/by-nc.markdown)
* `BY-NC-ND` – [Attribution-NonCommercial-NoDerivatives](4.0/by-nc-nd.markdown)
* `BY-NC-SA` – [Attribution-NonCommercial-ShareAlike](4.0/by-nc-sa.markdown)
* `BY-ND` – [Attribution-NoDerivatives](4.0/by-nd.markdown)
* `BY-SA` – [Attribution-ShareAlike](4.0/by-sa.markdown)
* `BY-SA(PH)` – Attribution-ShareAlike [legacy local license version 3.0 adapted for Philippine use](https://github.com/NewOpenBible/Creative-Commons-Markdown/blob/spaces/legacy/3.0/by-sa--PH.markdown)
